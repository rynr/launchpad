...
/**
 * Abstraction of commands that can be sent to a Midi-device, or be received by a Midi-device. Midi
 * stands for Musical Instrument Digital Interface.
 *
 * A {@link MidiCommand} consists of a command-byte and optional some further data bytes. The
 * command-byte contains a command in the higher nibble (four bytes) and a channel in the lower
 * nibble (four bytes).
 */
public class MidiCommand {
   ...
   *
   * @param command The command-byte of the {@link MidiCommand}.
   * @param data The optiona data-bytes of the {@link MidiCommand}.
   */
  ...
  /**
   * Retrieve the {@link Command}-abstraction of the higher nibble (four bytes) of the command-byte.
   *
   * @return The {@link Command}-abstraction of the higher nibble (four bytes) of the command-byte.
   */
  ...
  /**
   * Retrieve the {@link Channel}-abstraction of the lower nibble (four bytes) of the command-byte.
   *
   * @return The {@link Channel}-abstraction of the lower nibble (four bytes) of the command-byte.
   */
  ...
  public static class Builder {
    ...
    /**
     * Start the build with a {@link Command} and the {@link Channel}. For Launchpad it's always the
     * Channel 1.
     *
     * @param command The {@link Command} of the {@link MidiCommand}.
     * @param channel The {@link Channel} of the {@link MidiCommand}.
     */
     ...
     *
     * @param databytes The optional data-bytes of the {@link MidiCommand}.
    ...
    public MidiCommand toMidiCommand() {
      return new MidiCommand(statusbyte, databytes == null ? new byte[0] : databytes);
    }
  }
}
